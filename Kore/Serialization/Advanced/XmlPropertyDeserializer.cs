...
using Kore.Serialization.Core.Xml;

namespace Kore.Serialization.Advanced
{
    /// <summary>
    ...
    public sealed class XmlPropertyDeserializer : IPropertyDeserializer
    {
        ...
        {
            // ElementType
            property.ElementType = property.Type != null ? Kore.Serialization.Serializing.TypeInfo.GetTypeInfo(property.Type).ElementType : null;
        ...
        private void parseDictionaryProperty(DictionaryProperty property)
        {
            ...
            {
                var typeInfo = Kore.Serialization.Serializing.TypeInfo.GetTypeInfo(property.Type);
