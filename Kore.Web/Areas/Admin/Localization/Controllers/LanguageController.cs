...
namespace Kore.Web.Areas.Admin.Localization.Controllers
{
    ...
    public class LanguageController : KoreController
    {
        ...
        {
            if (!CheckPermission(KoreWebPermissions.LanguagesRead))
            {
                return new HttpUnauthorizedResult();
            }

            WorkContext.Breadcrumbs.Add(T(KoreWebLocalizableStrings.Localization.Title));
            WorkContext.Breadcrumbs.Add(T(KoreWebLocalizableStrings.Localization.Languages));

            ViewBag.Title = T(KoreWebLocalizableStrings.Localization.Title);
            ViewBag.SubTitle = T(KoreWebLocalizableStrings.Localization.Languages);

            return PartialView("Kore.Web.Areas.Admin.Localization.Views.Language.Index");
        }
        ...
        public JsonResult GetTranslations()
        {
            return Json(new
            {
                ...
                Columns = new
                {
                    Name = T(KoreWebLocalizableStrings.Localization.LanguageModel.Name).Text,
                    CultureCode = T(KoreWebLocalizableStrings.Localization.LanguageModel.CultureCode).Text,
                    IsEnabled = T(KoreWebLocalizableStrings.Localization.LanguageModel.IsEnabled).Text,
                    SortOrder = T(KoreWebLocalizableStrings.Localization.LanguageModel.SortOrder).Text,
                }
