        ...
        private void EnsureData(DbContext dbContext)
        {
            ...
            if (dataSettings.CreateSampleData)
            {
                ...
                regionService.Insert(new[]
                {
                    ...
                    new Region { Name = "Trinidad and Toba", CountryCode = "TT", RegionType = RegionType.Country, ParentId = northAmerica.Id },
                ...
                regionService.Insert(new[]
                {
                    ...
                    new Region { Name = "Bosnia and Herzevina", CountryCode = "BA", RegionType = RegionType.Country, ParentId = europe.Id },
