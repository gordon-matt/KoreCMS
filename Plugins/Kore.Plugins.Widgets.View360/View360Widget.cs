...
{
    public class View360Widget : WidgetBase
    {
        public View360Widget()
        {
            Mode = Mode.Fixed;
        ...
        {
            get { return "View360 Widget"; }
        }

        public override string DisplayTemplatePath
        {
            get { return "/Plugins/Plugins.Widgets.View360/Views/Shared/DisplayTemplates/View360Widget.cshtml"; }
        }

        public override string EditorTemplatePath
        {
            get { return "/Plugins/Plugins.Widgets.View360/Views/Shared/EditorTemplates/View360Widget.cshtml"; }
        }
