...
using System.Text;
using System.Xml;
using Kore.Serialization.Advanced;
using Kore.Serialization.Advanced.Deserializing;
using Kore.Serialization.Advanced.Serializing;
using Kore.Serialization.Advanced.Xml;
using Kore.Serialization.Core;
using Kore.Serialization.Deserializing;
using Kore.Serialization.Serializing;

namespace Kore.Serialization
{
    /// <summary>
    ...
    public sealed class SharpSerializer
    {
        ...
        private void initialize(SharpSerializerBinarySettings settings)
        {
            ...
            // Create Serializer and Deserializer
            Kore.Serialization.Advanced.Binary.IBinaryReader reader = null;
            Kore.Serialization.Advanced.Binary.IBinaryWriter writer = null;
        ...
        [MethodImpl(MethodImplOptions.Synchronized)]
        public byte[] SerializeToArray(object data)
        {
            using (var stream = new MemoryStream())
            {
                Serialize(data, stream);
