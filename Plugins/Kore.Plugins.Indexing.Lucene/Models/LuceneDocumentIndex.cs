...
namespace Kore.Plugins.Indexing.Lucene.Models
{
    public class LuceneDocumentIndex : IDocumentIndex
    {
        ...
        public LuceneDocumentIndex(string documentId, Localizer t)
        {
        ...
        public IDocumentIndex SetContentItemId(string contentItemId)
        {
