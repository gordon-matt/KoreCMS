...
namespace Kore.Web.Mvc.Filters
{
    ...
    public class FrontendAntiForgeryAttribute : FilterAttribute, IAuthorizationFilter
    {
        ...
        public FrontendAntiForgeryAttribute(bool ignore = false)
        {
            this._ignore = ignore;
        }
        ...
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            if (!securitySettings.EnableXsrfProtectionForFrontend)
            {
                return;
            }
