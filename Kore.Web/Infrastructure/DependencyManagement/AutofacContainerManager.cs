...
namespace Kore.Web.Infrastructure.DependencyManagement
{
    ...
    {
        //    public delegate void DependenciesConfiguredEventHandler(IContainer container);
        //    public static event DependenciesConfiguredEventHandler DependenciesConfigured;
        ...
        public void RegisterWebApi()
        {
            ...
            UpdateContainer(x =>
            {
                x.RegisterApiControllers(typeFinder.GetAssemblies().ToArray());
            });
            var resolver = new AutofacWebApiDependencyResolver(_container);
            GlobalConfiguration.Configuration.DependencyResolver = resolver;
            //GlobalConfiguration.Configuration.Services.Replace(typeof(IAssembliesResolver), new KoreAssembliesResolver());
            //GlobalConfiguration.Configuration.Services.Replace(
            //    typeof(IHttpControllerSelector),
            //    new KoreHttpControllerSelector(GlobalConfiguration.Configuration));
        }
