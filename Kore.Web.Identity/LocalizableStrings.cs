namespace Kore.Web.Identity
{
    ...
    {
        public const string ConfirmNewPassword = "Kore.Web.Identity/ConfirmNewPassword";
        public const string ConfirmPassword = "Kore.Web.Identity/ConfirmPassword";
        public const string EditMyProfile = "Kore.Web.Identity/EditMyProfile";
        ...
        public const string NoUserFound = "Kore.Web.Identity/NoUserFound";
        ...
        {
            public const string ChangePasswordSuccess = "Kore.Web.Identity/ManageMessages.ChangePasswordSuccess";
            public const string Error = "Kore.Web.Identity/ManageMessages.Error";
            public const string RemoveLoginSuccess = "Kore.Web.Identity/ManageMessages.RemoveLoginSuccess";
            public const string SetPasswordSuccess = "Kore.Web.Identity/ManageMessages.SetPasswordSuccess";
        }
    }
}