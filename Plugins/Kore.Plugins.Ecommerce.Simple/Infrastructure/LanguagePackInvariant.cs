        ...
        public IDictionary<string, string> LocalizedStrings
        {
            get
            {
                return new Dictionary<string, string>
                {
                    ...
                    { LocalizableStrings.CategoryModel.ExternalLink, "External Link" },
                    ...
                    { LocalizableStrings.CategoryModel.Slug, "URL Slug" },
                    { LocalizableStrings.CategoryModel.UseExternalLink, "Use External Link" },
                    ...
                    { LocalizableStrings.ProductModel.Slug, "URL Slug" },
