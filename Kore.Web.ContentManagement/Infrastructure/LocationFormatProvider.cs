    ...
    public class LocationFormatProvider : ILocationFormatProvider
    {
        ...
        public IEnumerable<string> AreaViewLocationFormats
        {
            get
            {
                return new[]
                {
                    "~/Themes/{3}/Areas/{2}/Views/Kore.Web.ContentManagement/{1}/{0}.cshtml",
                    "~/Themes/{3}/Areas/{2}/Views/Kore.Web.ContentManagement/Shared/{0}.cshtml",
        ...
        public IEnumerable<string> ViewLocationFormats
        {
            get
            {
                return new[]
                {
                    "~/Themes/{2}/Views/Kore.Web.ContentManagement/{1}/{0}.cshtml",
                    "~/Themes/{2}/Views/Kore.Web.ContentManagement/Shared/{0}.cshtml",
