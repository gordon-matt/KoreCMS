...
namespace Kore.Web.ContentManagement.FileSystems.Media
{
    public interface IStorageProvider
    {
        ...
        IStorageFolder RenameFolder(string oldPath, string newPath);
        ...
        IStorageFile RenameFile(string oldPath, string newPath);
        ...
        IStorageFile SaveFile(string path, Stream inputStream);
